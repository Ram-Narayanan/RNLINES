<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="RN_LINE.SignUp" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Contact Number" Style="margin-bottom: 15px" TextMode="Number"></asp:TextBox>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="User ID" Style="margin-bottom: 15px"></asp:TextBox>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="Password" TextMode="Password" Style="margin-bottom: 15px"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:Button class="btn btn-success btn-lg d-block w-100" ID="Button1" runat="server" Text="Sign Up"
